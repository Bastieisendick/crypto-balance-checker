class etherscanERC20TokensAPI {
    ...
    async _requestBalanceFromAPI(walletAdress, contractAdress) {
        ...
        const requestUrl = `https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=${contractAdress}&address=${walletAdress}&tag=latest&apikey=${this.apiKey}`;
...
etherscanERC20TokensAPI.id = "etherscanERC20Tokens";


export { etherscanERC20TokensAPI };